...
const theme = {
  ...
  roundness: 3,
  colors: {
    primary: "hsl(206, 48.70%, 45.90%)",
    onPrimary: "hsl(0, 0.00%, 99.99%)",
    primaryContainer: "hsl(211, 99.99%, 92.90%)",
    onPrimaryContainer: "hsl(222, 99.99%, 14.90%)",
    secondary: "hsl(11, 99.99%, 37.60%)",
    onSecondary: "hsl(0, 0.00%, 99.99%)",
    secondaryContainer: "hsl(25, 99.99%, 92.20%)",
    onSecondaryContainer: "hsl(356, 99.99%, 12.70%)",
    tertiary: "hsl(16, 99.99%, 19.20%)",
    onTertiary: "hsl(0, 0.00%, 99.99%)",
    tertiaryContainer: "hsl(15, 73.30%, 67.60%)",
    ...
    background: "hsl(180, 21.20%, 93.50%)",
